	 ...
	 $(document).ready(function () {
		    $.ajax({
				...
				// value[fieldValue] + "<br><br>-------------<br>");
					        $("#rssContent").append('<div class="feed"><div class="image"><img src="' + url + '" width=' + width 
					        		+ 'px /><div class="title"> Title:' + title 
					        		+ '</div><br><div class="pubDate">pubDate: ' + $(this).find("pubDate").text()
		...
		// delData(1054);
		    $(xml).find("item").each(function () {
		          ...
		          arr[i] = { title:$(this).find("title").text(), pubDate:$(this).find("pubDate").text(), description:$(this).find("description").text(), image:$(this).find("enclosure").attr('url')};
		    	
		    	  setData(arr[i]); // чем плоха данная схема? переделать на
									// передачу массива.
